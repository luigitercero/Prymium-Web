...
const Principal = ({sliderSink,sliderBidet}) => {
  return (
    <>
      <Head
        title="Extractores de Olores para Cocina | Prymium Guatemala"
        description="Explora extractores y campanas para cocina Prymium con estilo moderno y alto rendimiento para hogares en Guatemala."
        img={sobreAzulejo()}
      />
