...
const Principal = ({sliderSink,sliderBidet}) => {
  return (
    <>
      <Head
        title="Duchas de Lujo para Bano | Prymium Guatemala"
        description="Descubre duchas de lujo Prymium para bano: disenos modernos, acabados premium y calidad para remodelaciones en Guatemala."
        img={sobreAzulejo()}
      />
