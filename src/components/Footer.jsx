...
const Footer = () => {
  return (
    <footer className="container-footer">
      ...
      <section>
        <p>Redes Sociales</p>
        <a target="_blank" href="https://www.facebook.com/lavatrastosprymium" className="icon-container">
          <span className="icon"><img src="/images/icons/facebook-brands.webp" loading="lazy" alt="f" /></span>
        </a>
        <a target="_blank" href="https://www.instagram.com/lavatrastosprymium/" className="icon-container">
          <span className="icon"><img src="/images/icons/instagram-brands.webp" loading="lazy" alt="i" /></span>
        </a>
        <a target="_blank" href="https://www.youtube.com/channel/UCoseb5M5memG5PF67kF4slQ/featured" className="icon-container">
